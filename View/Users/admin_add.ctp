...
$this->Html->addCrumb(__d('admin', 'Admin Add %s User', $this->Form->value('User.id')));

?>
<div class="row">
    <div class="col-md-12">
        <h2 class="page-title"><?php echo __d('admin', 'Admin Add User'); ?></h2>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <?php echo __d('admin', 'Admin Add the User information'); ?>
                </div>
            </div>
