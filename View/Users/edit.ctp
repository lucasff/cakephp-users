...
$this->Html->addCrumb(__d('SolutionsCMS', 'Edit %s User', $this->Form->value('User.id')));

?>
<div class="row">
    <div class="col-md-12">
        <h2 class="page-title"><?php echo __d('SolutionsCMS', 'Edit User'); ?></h2>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <?php echo __d('SolutionsCMS', 'Edit the User information'); ?>63                </div>
            </div>
